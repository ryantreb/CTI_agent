...
echo 'export $(cat ~/ai-dev/CTI_agent/.env | xargs)' >> ~/.bashrc
source ~/.bashrc
...
| Project Root | `~/ai-dev/CTI_agent/` |
| Skills | `~/ai-dev/CTI_agent/skills/` |
| Evaluation Graders | `~/ai-dev/CTI_agent/evaluation/graders/` |
| Reports Output | `~/ai-dev/CTI_agent/reports/` |
